...
const LegalNotice = () => {
  return (
    <div className="min-h-[60vh] w-full flex flex-col items-center justify-center bg-gray-50 px-4 text-center cabin-400">
      <h1 className="text-3xl md:text-4xl font-bold text-(--color-dark) mb-4">Legal Notice</h1>
      <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
        Legal notices and disclosures are currently being updated. Please check back later or contact us directly.
      </p>
      <Link
        to="/"
