        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="inter-font text-gray-400 text-sm leading-relaxed">
              Engineering the edge of innovation. Building the tech that drives
          ...
          {/* Quick Links */}
          <div>
            <h3 className="cabin-400 text-lg font-bold mb-4">Quick Links</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="cabin-400 text-lg font-bold mb-4">Get In Touch</h3>
